...
public class Cachorro extends Pet implements Cacador, Saltador, Corredor{

	public Cachorro(String nome, String especie, int idade, String raca, boolean vacinado) {
